                            ...
                            <div class="table-responsive table-lg mt-3">
                                <table class="table table-bordered table-hover  mp-0  table-vcenter border-top text-nowrap" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-id='{{$product->product_id}}' onclick="window.location='{{route('vendor-stock-get-product',$product->product_id)}}'" target='_blank'>
                                            ...
                                            <td class="align-middle">
                                                <div class="btn-group align-top">
                                                    <button class="btn btn-sm btn-primary" type="button"><a href="{{route('vendor-stock-get-product',$product->product_id)}}" target="_blank" style="color:white">Show</a></button>
