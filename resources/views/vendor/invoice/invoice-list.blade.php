    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="input-group mb-2">
                <input type="text" class="form-control" id="search" name="search" placeholder="Enter the invoice id.....">
                                                ...
                                                @foreach ($invoices as $invoice)
                                                    <li class="active">
                                                        <a class="d-flex" target="_blank"
                                                            href="{{ route('vendor-invoice-show', [$invoice->invoice_id]) }}">
                                                            <img src="{{ URL::asset('assets/images/files/file.png') }}"
                                                                alt="img" class="w-7 h-7 mr-4">
                                                            <div class="mt-1">
                                                                <h5 class="mb-1 font-weight-bold mt-0">Invoice
                                                    ...
                                                    <li class="active">
                                                        <a class="d-flex" data-toggle="tab" href="#" aria-expanded="true">
                                                            <img src="'.URL::asset('assets/images/files/file.png').'"
                                                                alt="img" class="w-7 h-7 mr-4">
                                                            <div class="mt-1">
                                                                <h5 class="mb-1 font-weight-bold mt-0">No results found !
                                                                </h5>
...
@section('js')
    <script type="text/javascript">
        $('#search').on('keyup', function() {
            ...
            $.ajax({
                type: 'get',
                url: "{{ route('vendor-invoice-search') }}",
                data: {'search': $value},
