...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Depository List</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/"></a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="">Depository List</a></li>
            </ol>
        </div>
                ...
                <div class="col-12 mb-3">
                    <div class="e-panel card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('vendor-depository-add') }}">
                                ...
                                <div class="table-responsive table-lg mt-3">
                                    <table
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">Depository Name</th>
                                        ...
                                        @foreach ($depositories as $depository)
                                            <tr>
                                                <td>{{ $depository->depot_id }}</td>
                                                <td>{{ $depository->name }}</td>
                                                <td>{{ $depository->date_added }}</td>
                                                <td class="align-middle">
                                                    <div class="btn-group align-top">
                                                        <button class="btn btn-sm btn-info approve-btn" type="button"><a
                                                                href="{{ route("vendor-depository-show",[$depository->depot_id]) }}"
