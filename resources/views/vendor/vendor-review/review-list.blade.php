...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Review List</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="">Review List</a></li>
            </ol>
        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="btn-group align-top">
                                                            <a>
                                                                <button  data-review="{{ $review->text }}" data-effect="effect-scale" data-target="#show"
                                                                    data-toggle="modal"
