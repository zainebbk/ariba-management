...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Waiting approval ( {{ count($orders) }} )</h4>
            <ol class="breadcrumb">
                                    ...
                                    <table
                                        ...
                                        @foreach($orders as $order)
                                            <tr>
                                                ...
                                                <td><span class="badge badge-primary">{{$order->county ?? 0}}</span> </td>
                                                ...
                                                <td class="align-middle">
                                                    <div class="btn-group align-top">
                                                        <a href="{{ route('vendor-order-show-waiting', $order->order_id) }}">
