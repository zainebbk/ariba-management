    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="">Order To Verify</a></li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
                        ...
                        <tr>
                            <td colspan="8" class="text-right">
                                <button type="button" class="btn btn-primary modal-effect"
                                        data-effect="effect-scale" data-target="#approve" data-toggle="modal"><i
                                        class="fe fe-check mr-2"></i>Confirm
                                </button>
                                <button type="button" class="btn btn-primary modal-effect" data-effect="effect-scale" 
                                    data-target="#to_clarify" data-toggle="modal" ><i
                                    class="fe fe-alert-circle mr-2"></i>Clarify
                                </button>
                                <button type="button" class="btn btn-primary modal-effect"
        ...
        <div class="card overflow-hidden">
            ...
            <div class="card-body">
                ...
                <!--<div class="card overflow-hidden mt-6">
                    <div class="card-status bg-gray-100"></div>
                    <div class="card-body vendorhistory">
                        <h2 class="font-weight-bold">Add Order History</h2>
                        <div class="col-lg  mt-6">
                            <label class="col-md-12 form-label">Order Status</label>
                            <div class="col-md-12">
                                <select class="form-control select2" id="status_id" name="status">
                                    <option value="17">Approve</option>
                                    <option value="7">Deny</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg mt-4">
                            <label class="col-md-12 form-label">Comment</label>
                            <textarea class="form-control mb-4" rows="4" name='comment'></textarea>
                        </div>
                        <div class="btn-list text-right">
                            <button class="btn btn-gray" id="button-history" name="add-history" ><i
                                    class="fe fe-plus mr-2"></i>Add History
                            </button>
                        </div>
                    </div>
                </div>-->
...
@section('js')
    ...
    <script>
        ...
        $(".custom-switch-input").change(function(){
            if ($('.custom-switch-input:checked').length =={{count($order_products)}}) {
                $('#clarify').prop("disabled",true);
            } else {
                $('#clarify').prop("disabled",false);
            }
        });
