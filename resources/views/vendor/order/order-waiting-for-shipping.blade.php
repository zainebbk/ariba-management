...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Shipped Order ( {{ count($orders) }} )</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/"></a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="">Shipped Order</a></li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="btn-group align-top">
                                                            <a href="{{ route('vendor-order-show-shipped', $order->order_id) }}">
