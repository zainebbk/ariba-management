                        ...
                        <tr>
                            <td colspan="8" class="text-right">
                                <button type="button" class="btn btn-primary modal-effect"
                                        ...
                                        class="fe fe-check mr-2"></i>Shipped
                                </button>
                            </td>
                        </tr>
                    </table>
...
<div class="modal" id="shipped">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{route('vendor-order-shippe',$order->order_id)}}" method="post" class="needs-validation"
                  novalidate="">
                @csrf
                ...
                <div class="modal-body">
                    <div class="row">
                        <p style="margin-left: 20px">Are you sure you want to change the order status to shipped ?</p>
                    </div>
                </div>
