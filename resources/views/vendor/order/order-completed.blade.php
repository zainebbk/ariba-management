                                        ...
                                        <tbody>
                                            @foreach ($orders as $order)
                                                <tr>
                                                    ...
                                                    <iframe src="{{ route('vendor-invoice-pdf', $order->invoice_id) }}"
                                                        style="position:absolute; visibility: hidden" id="myframe"
                                                        name="{{ $order->invoice_id }}" class='frame'></iframe>
                                                    <td class="align-middle">
                                                        <div class="btn-group align-top">
                                                            <a
                                                                href="{{ route('vendor-order-show-finished', $order->order_id) }}">
                                                                <button class="btn btn-sm btn-primary"
                                                                    data-id="{{ $order->order_id }}"><i
                                                                        class="si si-pencil"></i> Edit &nbsp;
                                                                </button>
                                                            </a>
                                                            <button type="button" class="btn btn-sm btn-info print"
                                                                data-id="{{ $order->invoice_id }}" value="invoice"><i
                                                                    class="si si-printer"></i> Invoice
                                                            </button>
                                                        </div>
                                                    </td>
                                                </tr>
