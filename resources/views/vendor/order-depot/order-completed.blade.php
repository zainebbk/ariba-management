                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="w-7 h-7 rounded shadow mr-3">Order No</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="btn-group align-top">
                                                            <a
                                                                href="{{ route('vendor-order-depot-show-finished', $order->order_id) }}"><button
                                                                    class="btn btn-sm btn-info">
                                                                    <i class="si si-pencil"></i> Show &nbsp;
                                                                </button>
                                                            </a>
                                                            <button type="button" class="btn btn-sm btn-primary  print"
