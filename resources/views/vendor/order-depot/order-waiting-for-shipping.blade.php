                                                    ...
                                                    <td class="align-middle">
                                                        <div class="btn-group align-top">
                                                            <button class="btn btn-sm btn-info ml-1"
                                                                onclick="window.location='{{ URL::route('vendor-order-depot-show-shipped', $order->order_id) }}'">
                                                                <i class="si si-pencil"></i> Edit &nbsp;
                                                            </button>

                                                            <button class="btn btn-sm btn-primary"
                                                                onclick="window.location='{{ URL::route('vendor-order-depot-finish', $order->order_id) }}'">
                                                                <i class="si si-check mr-2"></i>Compelete
                                                            </button>
                                                        </div>
                                                    </td>
                                                </tr>
