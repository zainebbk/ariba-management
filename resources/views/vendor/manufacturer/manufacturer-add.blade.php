...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Create Manufacturer</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('vendor-manufacturer-list')}}"><i class="fe fe-layout  mr-2 fs-14"></i>Manufacturer</a></li>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body pb-2">
                    ...
                    @endif
                    <form action="{{ route('vendor-manufacturer-add') }}" method='POST' role="form" enctype="multipart/form-data">
                        @csrf
                        <div class="expanel expanel-default">
                            <div class="expanel-heading">
                                <h3 class="expanel-title" style="text-align: center">Manufacturer Information
                                </h3>
                            </div>
