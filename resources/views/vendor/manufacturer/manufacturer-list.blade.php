...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Manufacturer List</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/"></a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="">Manufacturer List</a></li>
            </ol>
        </div>
                ...
                <div class="col-12 mb-3">
                    <div class="e-panel card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('vendor-manufacturer-add') }}">
                                ...
                                <div class="table-responsive table-lg mt-3">
                                    <table
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">Manufacturer Name</th>
                                                ...
                                                <td class="align-middle">
                                                    <div class="btn-group align-top">
                                                        <button class="btn btn-sm btn-info approve-btn" type="button"><a
                                                                href="{{ route("vendor-manufacturer-show",[$manufacturer->manufacturer_id]) }}"
