        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body pb-2">
                    ...
                    @endif
                    <form action="{{ route('vendor-employee-add') }}" method='POST' role="form" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="expanel-body">
                                <div class="row row-sm">
                                    ...
                                    <div class="col-lg">
                                        ...
                                        <input class="form-control mb-4" placeholder="Employee Name" type="text"
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-lg">
                                        ...
                                        <input class="form-control mb-4" placeholder="Birthday" type="date" name='birthday'
                                            value='{{ old('birthday') }}'>
                                    </div>

                                    <div class="col-lg">
                                        <label class="col-md-12 form-label">User Group</label>
                                        <div class="col-md-12">
