        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body pb-2">
                    ...
                    <form action="{{ route('vendor-employee-update', [$user->vendor_employee_id]) }}" method='POST' role="form"
                        ...
                        <div class="expanel expanel-default">
                            ...
                            <div class="expanel-body">
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-lg">
                                        <label class="col-md-12 form-label">User Groups</label>
                                        <div class="col-md-12">
                                            <select multiple="multiple"
                                                ...
                                                @foreach ($roles as $role)
                                                    <option value="{{ $role->role_id }}"
                                                        {{ $userRoles->contains('role_id', $role->role_id) ? 'selected' : '' }}>
                                                        {{ $role->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
