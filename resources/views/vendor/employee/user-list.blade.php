                ...
                <div class="col-12 mb-3">
                    <div class="e-panel card">
                        <div class="card-body">
                                ...
                                <a href="{{ route('vendor-employee-add') }}">
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="wd-15p border-bottom-0">User Groups</th>
                                                    ...
                                                    <td>
                                                        @if (!empty($user->getRoleNames()))
                                                            @foreach ($user->getRoleNames() as $role)
                                                                <label
                                                                    class="badge badge-success">{{ $role->name }}</label>
                                                            @endforeach
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="btn-group align-top">
                                                            <button class="btn btn-sm btn-info approve-btn" type="button"><a
                                                                    href="{{ route("vendor-employee-show",[$user->vendor_employee_id]) }}" class="approve"
