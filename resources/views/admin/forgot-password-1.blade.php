										...
										<div class="card-body">
											<form method="POST" action="{{ route('password.email') }}">
												...
												<div class="input-group mb-4">
													...
													<input class="form-control @error('email') is-invalid state-invalid @enderror"  placeholder="Enter Email" type="email" name="email" value="{{ old('email') }}" required autocomplete="Enter Email" autofocus >
												</div>
