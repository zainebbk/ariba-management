										...
										<div class="dropdown profile-dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												<div class="text-center">
                                                    <a href="{{url('/' . $page='#')}}" class="dropdown-item text-center user pb-0 font-weight-bold"> {{$store_name->name ?? ''}} &nbsp;</a>
                                                    <span class="text-center user-semi-title">{{ Auth::guard("vendor")->user()->firstname ?? '' }} {{   Auth::guard("vendor")->user()->lastname ?? '' }}</span>
                                                ...
                                                <a class="dropdown-item d-flex"  href="{{ route('vendor.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
