                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top" class="content-item"
                                                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                                        <p
                                                            style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;padding-bottom:5px;">
                                                            Hello <b>{{ $firstname }}</b> ,</p>
                                                        <p
                                                            style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;padding-bottom:5px;">
                                                        ...
                                                        <p
                                                            ...
                                                            Please change your password from the application : </p>
                                                        <ul style="list-style-type: disc;">
                                                            <li
                                                                style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;padding-bottom:3px;">
                                                                Email : {{ $email }} </li>
                                                            <li
                                                                style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;padding-bottom:3px;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="center" valign="middle" class="btn-content"
                                                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background:#8B20DA;border:2px solid #8B20DA;border-radius:30px;color:#fff;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:4px 20px;"
                                                        bgcolor="#8B20DA">
                                                        <a href="https://www.ariba.ma" target="_blank"
                                                            style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#ffffff !important;display:block;font-family:Arial, sans-serif;font-size:13px;font-weight:bold;text-decoration:none;">Open
                                                            Application</a>
                                                    </td>
                                                </tr>
                                            </tbody>
