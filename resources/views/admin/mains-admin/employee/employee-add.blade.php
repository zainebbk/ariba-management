        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body pb-2">
                    ...
                    @endif
                    <form action="{{route('employee-add')}}" method='POST' role="form" enctype="multipart/form-data">
                        @csrf
                        <div class="expanel expanel-default">
                            <div class="expanel-heading">
                                <h3 class="expanel-title" style="text-align: center">Employee Personal Information &nbsp</h3>
                            </div>
                            <div class="expanel-body">
                                <div class="row row-sm">
                                    ...
                                    <div class="col-lg">
                                        ...
                                        <input class="form-control mb-4" placeholder="Birthday" type="date" name='birthday' value="{{old('birthday')}}">
                                    </div>
                                </div>
                                <div class="row row-sm">
                                    <div class="col-lg">
