...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Show Order</h4>
            <ol class="breadcrumb">
            ...
            <div class="card-body">
                <table class="table details-table">
                    ...
                    <tr>
                        ...
                        <td class="border-0"><a
                                href="{{route("update-customer",$order->customer_id)}}">{{$order->firstname}} {{$order->lastname}}</a>
                        </td>
                    </tr>
                    <tr>
                        <th>Email</th>
                    ...
                    <tr>
                        ...
                        <td> @if($order->payment_code=="cod") Cash On
                            Delivery @else {{$order->payment_method}} @endif </td>
                    </tr>
                    <tr>
            ...
            <div class="card-body">
                <table class="table details-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route("verify-sales-agent-approved",$order->s_id) ?? "#"}}">{{$order->s_firstname ?? '--None--'}} </a>
                        </td>
                    </tr>
                    </tbody>
                </table>
                            ...
                            @foreach ($order_options as $order_option)
                                @if ($order_product->order_product_id == $order_option->order_product_id)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route("update-product",$order_product->product_id)}}"><p
                                                    class="font-weight-semibold mb-1">{{$order_product->name}}</p>
                                            </a>by Seller <a href="{{route("update-vendor",$order_product->vendor_id)}}"
                                                             class="text-primary">{{$order_product->display_name}}</a>
                                        </td>
                            ...
                            <td colspan="7" class="text-right">
                                ...
                                @can('order-deny')
                                    <button type="button" class="btn btn-secondary modal-effect"
                                            ...
                                            data-toggle="modal"><i class="fe fe-slash mr-2"></i>Deny
                                    </button>
                                @endcan
                            </td>
                        </tr>
...
<div class="modal  fade" id="smallmodal" tabindex="-1" role="dialog" aria-labelledby="smallmodal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{route('order-deny',$order->order_id)}}" method="post">
                    @csrf
...
<div class="modal" id="approve">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{route('order-approve',$order->order_id)}}" method="post" class="needs-validation"
                  novalidate="">
                @csrf
                <div class="modal-header">
