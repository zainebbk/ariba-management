...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Order Approved ( {{ count($orders) }} )</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/"><i class="fe fe-layout  mr-2 fs-14"></i>Tables</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="">Order Approved</a></li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
                        ...
                        <div class="card-body">
                            <div class="e-table">
                                <div class="table-responsive table-lg mt-3">
                                    <table class="table table-bordered mp-0 table-striped table-vcenter border-top text-nowrap" id="example-order">
                                        <thead>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <div class="btn-group align-top">
                                                        <button class="btn btn-sm btn-info" data-id="{{$order->order_id}}"><a href="{{ route('order-show-waiting', $order->order_id) }}"  style="color: white">Edit</a></button>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
