                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="wd-15p border-bottom-0">Title (French)</th>
                                                <th class="wd-15p border-bottom-0">Title (Arabic)</th>
                                                <th class="wd-15p border-bottom-0">Title (English)</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data['products'] as $product)
                                                <tr>
                                                    <td><img class="w-7 h-7 rounded shadow mr-3" @if (Illuminate\Support\Str::contains($product->image, 'catalog')) src="https://ariba.ma/image/{{ $product->image }}"  @else src="/uploads/{{ $product->image }}" @endif></td>
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="btn-group align-top">
                                                            <button class="btn btn-sm btn-primary" type="button"><a
                                                                    href="update/{{ $product->product_id }}" target="_blank"
