...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Add Depot</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/"><i class="fe fe-layout  mr-2 fs-14"></i>Tables</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="">Add Depot</a></li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Depot </h3>
                </div>
                <div class="card-body pb-2">
                    ...
                    @endif
                    <form action="{{route('depot-add')}}" method='POST' role="form" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="expanel-body">
                                <div class="row row-sm">
                                    <div class="col-lg">
                                        ...
                                        <input class="form-control mb-4" placeholder="Depot Name" type="text" name='name' value="{{old('name')}}">
                                    </div>
                                    <div class="col-lg">
                                        <label class="col-md-12 form-label">Address</label>
                                        <input class="form-control mb-4" placeholder="Depot Address" type="text" name='address' value="{{old('address')}}">
                                    </div>
                                    <div class="col-lg">
                                        <label class="col-md-12 form-label">Volume</label>
                                        <input class="form-control mb-4" placeholder="Volume" type="number" step="any" name='volume' value="{{old('volume')}}">
                                    </div>
                                    <div class="col-lg">
                                        <label class="col-md-6 form-label">Vendor</label>
                                        <div class="col-md-12">
                                            <select class="search-box" name="vendor_id">
