...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Bilan Passif</h4>
        </div>
                                        ...
                                        <tbody id="change-role">
                                            @foreach ($cpcs as $cpc) 
                                                ...
                                                box-shadow: 0 0px 10px -5px rgb(112 94 200 / 50%);" @endif>
                                                    ...
                                                    <td><span @if($cpc->type=='Finance permanent') class="badge badge-gradient-danger"
                                                         @elseif($cpc->type=='Passif circulant') class="badge badge-gradient-success"
                                                          @else class="badge badge-gradient-warning" @endif >{{ $cpc->type }}</span>
                                                    </td>
                                                    <td class="align-middle">
                                                        <div class="btn-group align-top">
                                                            <a  target="_blank"
                                                                href="{{ route('bilan-passif-show', [$cpc->id]) }}">
