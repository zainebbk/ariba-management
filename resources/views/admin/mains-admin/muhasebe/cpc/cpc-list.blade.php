...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">CPC " Comptes de Produits et Charges " list :</h4>
        </div>
                        ...
                        <div class="card-body">
                            {{-- @can('role-create')
                                <a href="{{ route('cpc-show-add') }}"><button type="button" class="btn btn-primary"><i
                                            class="fe fe-plus mr-2"></i>Add to cpc</button>
                                </a>
                            @endcan --}}
                            <div class="e-table">
                                        ...
                                        <tbody id="change-role">
                                            @foreach ($cpcs as $cpc) 
                                                <tr>
                                                    ...
                                                    <td>{{ $cpc->Parent }}</td>
                                                    <td>{{ $cpc->Model }}</td>
                                                    <td><span class="badge badge-gradient-danger">{{ $cpc->Type }}</span></td>
                                                    <td class="align-middle">
                                                        <div class="btn-group align-top">
                                                            <a
                                                                href="{{ route('cpc-show', [$cpc->id]) }}" target="_blank">
