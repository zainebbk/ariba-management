...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Vendor List</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/"><i class="fe fe-layout  mr-2 fs-14"></i>Tables</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="/">Vendors List</a></li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            @foreach ($data['vendors'] as $vendor)
                                                <tr>
                                                    @php $imagesrc="http://www.ariba.ma/image/$"; @endphp
                                                    <td><img class="w-7 h-7 rounded shadow mr-3"
                                                            src="{{ $imagesrc ?? '' }}" alt="{{ $vendor->vendorname }}">
                                                    </td>
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="btn-group align-top">
                                                            <button class="btn btn-sm btn-info" type="button"><a
                                                                    href="vendor/update/{{ $vendor->vendor_id }}"
