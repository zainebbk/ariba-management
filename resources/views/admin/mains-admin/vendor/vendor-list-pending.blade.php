...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Vendor : Pending list</h4>
            <ol class="breadcrumb">
                                ...
                                <div class="table-responsive table-lg mt-3">
                                    <table
                                        ...
                                        <tr>
                                            ...
                                            @can('vendor-disapprove')
                                                <th class="wd-15p border-bottom-0">Disapprove</th>
                                            @endcan
                                                ...
                                                @can('vendor-disapprove')
                                                    <td class="align-middle">
                                                        <div class="btn-group align-top">
                                                            <button @if ($vendor->approved == 0) disabled @endif
                                                            class="btn btn-sm btn-danger disapprove"
                                                                    data-id="{{ $vendor->vendor_id }}"
                                                                    @if ($vendor->approved == 1)
                                                                    data-placement="bottom"
                                                                    data-toggle="tooltip" title="Disapprove"
                                                                @endif ><i class="fa fa-thumbs-o-down"></i></button>
                                                        </div>
                                                    </td>
                                                @endcan
                                                <td class="align-middle">
