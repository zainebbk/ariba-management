...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">IP Address : Blocked List</h4>
        </div>
            ...
            <div class="row flex-lg-nowrap">
                <div class="col-12 mb-3">
                    <div class="e-panel card">
                        <div class="card-body">
                            @can('role-create')
                                <a href="{{ route('blacklist-show-add') }}"><button type="button" class="btn btn-primary"><i
                                            class="fe fe-plus mr-2"></i>Add to Blacklist</button>
                                </a>
                            @endcan
                            <div class="e-table">
                                    ...
                                    <table
                                        ...
                                        <tbody id="change-role">
                                            @foreach ($blacklists as $blacklist)
                                                 @php 
                                                    $iso = substr($blacklist->ip_address, 8);
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="btn-group align-top">
                                                            <a
                                                                href="{{ route('blacklist-remove', [$blacklist->ip_address]) }}">
