...
<div>
        ...
        <div class="card-body">
            <div class="row row-sm">
                ...
                <div class="col-lg-8 col-sm-12">
                    ...
                    <form action="{{ route('stock_save', $id)}}"  method="post">
                        @csrf
                            ...
                            <table class="table card-table table-vcenter text-nowrap">
                                ...
                                <thead>
                                    <tr>
                                        <th>Value</th>
                                        <th>Quantity</th>
                                        <th> <span class="badge badge-default  mt-2"> {{$product[0]->set_number}}</span> &nbsp; Set</th>
                                    </tr>
                                </thead>
 ...
 <!-----------   Stock   -------------->
            ...
            <form action="{{ route('update_stocks' , $id) }}" method="post">
                @csrf
...
<!-----------  Add New Stock   -------------->
            ...
            <form action="{{ route('place_save') }}" method="get">
