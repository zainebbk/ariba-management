                ...
                <tbody>
                  ...
                  <tr>
                    <td align="center" valign="top" class="header-logo" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:10px 50px 30px;">
                      <!-- // Logo block // -->
                      <a href="https://ariba.ma" target="_blank" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#4DC3C9;text-decoration:none;"><img src="https://infodat.com/mgmt/assets/images/brand/logo.png" alt="Ariba logo" width="180" height="36" style="-ms-interpolation-mode: bicubic; border: 0; display: block; max-width: 100%; outline: none; text-decoration: none; vertical-align: middle; width: auto"></a>
                    </td>
                  </tr>

                  <tr>
                    <td align="left" valign="top" class="header" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background:#8B20DA url('https://link-to-another-hosted-image.png') repeat-y top;background-size:560px 150px;border-radius:5px 5px 0 0;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:28px 130px;" bgcolor="#8B20DA">
                      <!-- // Header block // -->
                        ...
                        <tbody>
                          <tr>
                            <td align="center" valign="middle" class="mobile-centered-container" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                              <h1 class="header-heading mobile-centered-item" style="color:#fff;font-size:24px;letter-spacing:-.43px;line-height:30px;margin:0;padding:0 0 20px;">Complete and Edit your information</h1>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                    ...
                    <tr>
                      <td align="left" valign="top" class="section is-top-merged" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background:#fff;border-radius:0 0 5px 5px;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:20px 50px 40px;" bgcolor="#ffffff">
                          ...
                          <tbody>
                            <tr>
                              <td align="center" valign="top" class="section-heading" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:15px;">
                                <h5 style="color:#9B9B9B;font-size:11px;margin:0;padding:0;text-transform:uppercase;">Support Team</h5>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" valign="top" class="content-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                <h1 style="color:#4A4A4A;font-size:24px;letter-spacing:-.7px;line-height:29px;margin:0;padding:0;">
                                  <span class="highlighted-text" style="color: #000">Complete your account information</span>
                                </h1>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td align="left" valign="top" class="content-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;padding-bottom:5px;">Hello <b>{{$firstname}}</b> ,</p> 
                                <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;padding-bottom:5px;">

                                Our team has reviewed your information, and it appears to be malformed or incomplete, your account is restricted at the moment, please verify and complete the information mentioned below, we will re-examine your account once you are finished.

                            	</p>
                                
                                <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;padding-bottom:10px;"> 
                                The information concerned are :  
                            	</p>

                                <ul style="list-style-type: disc;">

                                  @foreach($fields as $field)
                                    <li style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;padding-bottom:3px;"> The {{$field}} .  </li>
                                  @endforeach
                                  
                                </ul>

                                <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;padding-bottom:6px;"> If you have any questions please do not hesitate to contact us at <a href="mailto:clientservice@ariba.ma">clientservice@ariba.ma</a> </p>
                                <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0padding-bottom:6px;">Best regards,</p>
                                <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;">Ariba</p>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                        <table border="0" cellpadding="0" cellspacing="0" align="center" class="btn" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                          <tbody>
                            <tr>
                              <td align="center" valign="middle" class="btn-content" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background:#8B20DA;border:2px solid #8B20DA;border-radius:30px;color:#fff;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:4px 20px;" bgcolor="#8B20DA">
                                <a href="https://www.ariba.ma" target="_blank" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#ffffff !important;display:block;font-family:Arial, sans-serif;font-size:13px;font-weight:bold;text-decoration:none;">Open Application</a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
