...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Sales Agent : Second Approval</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/"><i class="fe fe-layout  mr-2 fs-14"></i>Tables</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="">Sales Agent Second Approval</a></li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
                                            ...
                                            <tr id="tr-{{ $sales_agent->salesagent_id}}">
                                                ...
                                                <td class="align-middle">
                                                    <div class="btn-group align-top">
                                                        <button class="btn btn-sm btn-info" data-id="{{$sales_agent->salesagent_id}}"><a  href="update/{{$sales_agent->salesagent_id}}" style="color: white">Preview</a></button>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
