...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Sales Agent : First Approval</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/"><i class="fe fe-layout  mr-2 fs-14"></i>Tables</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="">Sales Agent First Approval</a></li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
                                            ...
                                            <tr id="tr-{{ $sales_agent->salesagent_id}}">
                                                ...
                                                <td class="align-middle">
                                                    <div class="btn-group align-top">
                                                        <button class="btn btn-sm btn-info approve-btn" type="button" data-target="#smallmodal" data-toggle="modal" data-id="{{$sales_agent->salesagent_id}}"><a   class="approve" style="color:white">Approve</a></button>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="smallmodal1">Approval</h5>
