...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Product Review</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="">Product reviews</a></li>
            </ol>
        </div>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bi">Product Name</th>
                                        ...
                                        <tbody id="change-permission">
                                            @foreach ($reviews as $review)
                                                <tr>
                                                    ...
                                                    <td><a
                                                            href="{{ route('update-product', $review->product_id) }}">{{ $review->product_name }}</a>
                                                    </td>
                                                    <td><a
                                                            href="{{ route('update-vendor', $review->vendor_id) }}">{{ $review->vendor_name }}</a>
                                                    </td>
                                                    <td>{{ $review->author }}</td>
                                                    <td></i><span class="badge badge-primary">
