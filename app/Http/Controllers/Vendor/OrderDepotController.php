...
class OrderDepotController extends Controller
{
    ...
    public function OrderApproved()
    {
        ...
        return view('vendor.order-depot.order-approved', [
            'orders' => $orders,
        ]);
    }
    public function WaitingShipping()
    {
        ...
        return view('vendor.order-depot.order-waiting-for-shipping', [
            'orders' => $orders,
        ]);
    }
    ...
    public function OrderCompleted()
    {
        ...
        return view('vendor.order-depot.order-completed', [
            'orders' => $orders,
        ]);
    }
    ...
    // public function SetDeliveyMethodAriba($order_id, Request $request)
    // {
    //     $order = self::getOrder($order_id,2);
    //     if(!$order) abort(404);

    //     DB::table("order_shipment")->insert([
    //         ["method_shipment" => "Ariba Express", "order_id" => $order_id, "courier_id" => $request->courierID,
    //         "vendor_id" => auth()->id()]
    //     ]);
    ...
    public function OrderShowApproved($order_id)
    {
        ...
        return view('vendor.order-depot.order-show-approved', [
    ...
    public function OrderShowShipped($order_id)
    {
        ...
        return view('vendor.order-depot.order-show-shipped', [
            'order' => $order,'order_products' => $order_products,
            'order_options' => $order_options,'order_history' => $order_history,
        ]);
    }
    ...
    public function OrderShowFinished($order_id)
    {
        ...
        return view('vendor.order-depot.order-show-finished', [
            'order' => $order,'order_products' => $order_products,
            'order_options' => $order_options,'order_history' => $order_history,
        ]);
    }
    ...
    public function shippe(Request $request, $id)
    {
        ...
        return redirect()->route('vendor-order-depot-approved')->with('success', 'The order has been shipped successfully!');
    }
    ...
    public function finish(Request $request, $id)
    {
        ...
        return redirect()->route('vendor-order-depot-shipped')->with('success', 'The order has been completed successfully!');
    }
    ...
    public function cancel(Request $request, $id)
    {
        ...
        return redirect()->route('vendor-order-depot-approved')->with('success', 'The order has been canceled successfully!');
    }
