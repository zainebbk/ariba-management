...
class InvoiceController extends Controller
{
    ...
    {
         $this->middleware('permission:invoice-list', ['only' => ['invoice','search','showInvoice']]);
         $this->middleware('permission:invoice-create', ['only' => ['printInvoicePDF']]);
         $this->vendor=1;
    }
    ...
    public function invoice()
    {
        ...
        return view('admin.mains-admin.invoice.invoice-list',['invoices'=>$invoices]);
    }
    ...
    public function showInvoice($id)
    {
        ...
        return view('admin.mains-admin.invoice.invoice-show', [
    ...
    public function printInvoicePDF($id)
    {
        ...
        $invoice= DB::table('vendor_invoice')->where('vendor_id',$this->vendor)->where('order_id',$order->order_id)->first();
            ...
            return view('admin.mains-admin.invoice.invoice-print', [
            'order' => $order,'order_products' => $order_products,
